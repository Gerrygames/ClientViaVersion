...
public class EntityTracker extends StoredObject {
	...
	public void sendVehicleMove(PlayerPosition position) throws Exception {
		PacketWrapper vehicleMove = new PacketWrapper(0x10, null, getUser());
		vehicleMove.write(Type.DOUBLE, position.getPosX());
		vehicleMove.write(Type.DOUBLE, position.getPosY());
		vehicleMove.write(Type.DOUBLE, position.getPosZ());
		vehicleMove.write(Type.FLOAT, position.getYaw());
		vehicleMove.write(Type.FLOAT, position.getPitch());
		ViaTransformerOut.sendToServer(vehicleMove, Protocol1_8TO1_9.class, true, false);
	}

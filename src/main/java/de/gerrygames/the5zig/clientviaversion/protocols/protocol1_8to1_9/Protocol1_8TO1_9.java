package de.gerrygames.the5zig.clientviaversion.protocols.protocol1_8to1_9;
...
import de.gerrygames.the5zig.clientviaversion.protocols.protocol1_8to1_9.chunks.ChunkPacketTransformer;
import de.gerrygames.the5zig.clientviaversion.protocols.protocol1_8to1_9.items.ItemReplacement;
			...
			public void registerMap() {
				...
				handler(new PacketHandler() {
					...
					public void handle(PacketWrapper packetWrapper) throws Exception {
						...
						ViaTransformerOut.sendToServer(confirm, Protocol1_8TO1_9.class, true, true);
					}
				});
			}
		});
				...
				handler(new PacketHandler() {
					...
					public void handle(PacketWrapper packetWrapper) throws Exception {
						if (packetWrapper.get(Type.VAR_INT, 0)==-1) {
							...
							ViaTransformerOut.sendToServer(useItem, Protocol1_8TO1_9.class, true, false);
						}
					}
				});
				handler(new PacketHandler() {
				...
				handler(new PacketHandler() {
					...
					public void handle(PacketWrapper packetWrapper) throws Exception {
						...
						if (vehicle!=-1 && tracker.getClientEntityTypes().getOrDefault(vehicle, Entity1_10Types.EntityType.SLIME)==Entity1_10Types.EntityType.BOAT) {
							...
							steerBoat.write(Type.BOOLEAN, forward!=0.0f || left>0.0f);
							ViaTransformerOut.sendToServer(steerBoat, Protocol1_8TO1_9.class, true, false);
						}
					}
				});
			}

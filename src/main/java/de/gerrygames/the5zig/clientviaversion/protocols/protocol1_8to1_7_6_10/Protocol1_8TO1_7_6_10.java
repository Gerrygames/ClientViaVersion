package de.gerrygames.the5zig.clientviaversion.protocols.protocol1_8to1_7_6_10;
...
public class Protocol1_8TO1_7_6_10 extends Protocol {
	private static ValueReader xyzToPosition = new ValueReader<Position>() {
		@Override
					...
					public void handle(PacketWrapper packetWrapper) throws Exception {
						...
						if (!online && entry!=null) {
							...
							if (gameProfile!=null) {
								...
								entry = new Tablist.TabListEntry(name, UUID.randomUUID());
							}
						...
						if (channel.equals("MC|Brand")) {
							Via.getPlatform().runSync(new Runnable() {
								...
								public void run() {
									...
									Tablist.TabListEntry oldEntry = tablist.getTabListEntry(profile.getName());
									Tablist.TabListEntry entry = new Tablist.TabListEntry(profile.getName(), profile.getId());
									if (oldEntry!=null) {
									...
									add.write(Type.VAR_INT, profile.getProperties().entries().size());
									for (Map.Entry<String, com.mojang.authlib.properties.Property> propertyEntry : profile.getProperties().entries()) {
										com.mojang.authlib.properties.Property property = propertyEntry.getValue();
										entry.properties.add(new Tablist.Property(property.getName(), property.getValue(), property.getSignature()));
									...
									add.write(Type.VAR_INT, The5zigAPI.getAPI().getGameMode().ordinal());
									add.write(Type.VAR_INT, 0);
									add.write(Type.BOOLEAN, entry.displayName!=null);
									if (entry.displayName!=null) {
										add.write(Type.STRING, entry.displayName);
									}
									tablist.add(entry);
									try {
	...
	static {
		placeable.add(6); placeable.add(27); placeable.add(28); placeable.add(30); placeable.add(31); placeable.add(32);
		placeable.add(37); placeable.add(38); placeable.add(39); placeable.add(40); placeable.add(50); placeable.add(65);
		placeable.add(66); placeable.add(69); placeable.add(70); placeable.add(72); placeable.add(76); placeable.add(77);
		placeable.add(96); placeable.add(106); placeable.add(111); placeable.add(131); placeable.add(143); placeable.add(147);
		placeable.add(148); placeable.add(157); placeable.add(167); placeable.add(175);
